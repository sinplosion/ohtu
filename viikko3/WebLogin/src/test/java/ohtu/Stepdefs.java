...
public class Stepdefs {
    ...
    public void usernameAndPasswordAndUnmatchingPasswordConfirmationAreEntered(String username, String password,
    ...
    @When("correct username {string} and password {string} is entered")
    public void correctUsernameAndPasswordIsEntered(String username, String password) {
        logInWith(username, password);
    ...
    public void registerNewUser(String username, String password, String passwordConfirmation) {
